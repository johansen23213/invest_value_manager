...
**Concentracion:** Oligopolio en nichos, fragmentado en conjunto
**Top 5 market share:** ~21% (SAP, Salesforce, Oracle, Microsoft, Intuit)

| Empresa | Nicho | Market Share | Fortaleza |
|---------|-------|--------------|-----------|
| Microsoft | SaaS general | #1 overall | Ecosistema, enterprise, Azure |
| Salesforce | CRM | #1 (60%+) | Plataforma, integraciones |
...
|--------|--------------|-------|
| Tipos de interes | **ALTA** | Tasas altas comprimen P/E de growth stocks |
| Recesion | Media | Enterprise es sticky, SMB mas expuesto |
| Inflacion | Baja | Pricing power para pasar costos |

**Mejor fase del ciclo:** Early/Mid (expansion de IT budgets)
**Beta tipico:** 1.2-1.5
**Correlacion con Fed:** Inversa - recortes de tasas = re-rating de software

---

## Disrupcion y Riesgos

### Tecnologicos (AI Impact)
...
**Mi contra-tesis:**
"El mercado sobre-reacciona a narrativas de AI. Los incumbentes con moats (datos, ecosistemas, switching costs) NO seran disruptados facilmente. Ademas, estan integrando AI MAS RAPIDO que startups. La oportunidad esta en quality compounders castigados injustamente por el miedo a disrupcion."

**Flujos de fondos (12m):** Inflows masivos en AI/Tech ETFs, pero outflows de software SaaS puro
...
### Para analisis profundo (Tier A/B potential)
...
| MSFT | Microsoft | Excelente empresa pero P/E 35x, no MoS |
...
- Mover de "Empresas Objetivo" o "Watchlist" a "Nuestras Posiciones Actuales"
