...
**Concentracion:** Oligopolio en muchas categorias, pero fragmentado globalmente
**Top 10 global market share:** ~30% (Nestle, P&G, Unilever, PepsiCo, Coca-Cola dominan)

| Empresa | Market Cap | Region | Fortaleza |
|---------|------------|--------|-----------|
| Nestle | $320B | Suiza | Portfolio diversificado, pricing power |
| Procter & Gamble | $410B | US | Marcas premium, innovacion |
...
| Danone | $39B | Francia | Dairy, agua, baby food |

**Barreras de entrada:** Medias-Altas
- Distribucion y shelf space son criticos
- Marcas establecidas tienen lealtad (pero decreciente)
- Escala en manufacturing y marketing
- Pero: private label demuestra que barreras son superables
...
|--------|--------------|-------|
| Tipos de interes | Media | Yield stocks sufren cuando tipos suben |
...
**Comportamiento historico en recesiones:**
- Outperformed S&P 500 en las ultimas 3 recesiones
- 2022 (mini-bear): S&P -17%, Consumer Staples -4%
- Downside capture ratio: 78% (solo captura 78% de las caidas del mercado)
...
- **Players:** Philip Morris, BAT, Imperial Brands, Altria, Japan Tobacco
- **Dinamica:** ESG outflows, regulacion, pero FCF masivo y transicion a smoke-free
...
|------------|--------------|---------|
| Impuestos azucar (global) | Alta | Medio - Beverage companies |
| Restricciones tobacco | Muy Alta | Alto - Pero ya priced in |
| Etiquetado nutricional | Alta | Bajo - Adaptable |
