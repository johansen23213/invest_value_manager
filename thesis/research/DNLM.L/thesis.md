...
|----------|-------|-----|-------------|
| Financial Quality | 32 | 40 | ROIC spread +16.8pp, FCF margin 11.9%, leverage 1.4x (ex-leases 0.33x), 4/5 FCF consistency |
...
Dunelm is the UK's largest homewares and home furnishing specialist retailer. Founded in 1979 by Bill Adderley as a curtain stall in Leicester market, it has grown to 200+ superstores across the UK plus a strong digital platform (41% of sales).

**Problem Solved:** One-stop-shop for home furnishing at affordable-to-mid price points. Unlike IKEA (which requires large format destination trips and self-assembly), Dunelm offers a curated, wide range (300,000+ products) in convenient out-of-town superstores with established digital delivery.

**Revenue Model:** Transaction-based retail (not subscription). Revenue is predominantly product sales with a relatively balanced mix of:
- Soft furnishings (curtains, bedding, cushions, rugs) -- higher margin, repeat purchase
...
|--------|-------|---------|
| Gross Margin | 52.4% | +17pp vs sector. Exceptional for a retailer. Private label ~30% of sales drives this. |
| Operating Margin | 12.5% | Healthy for UK retail, improved from 12.1% prior year |
| FCF Margin | 11.9% | Strong cash conversion |
| Capex % Revenue | 2.5% | Asset-medium -- stores are leased (IFRS16), physical capex is modest |
| Revenue/Store | ~GBP 8.8M | Highly productive stores |
| LTV/CAC | Not disclosed | But repeat purchase nature + loyalty platform (6M+ members) = high |

### Capital Intensity and IFRS 16

**CRITICAL CLARIFICATION on D/E of 3.18:**

The headline debt-to-equity ratio of 318% is heavily distorted by IFRS 16 lease accounting.

| Component | Amount |
|-----------|--------|
| Total Debt (reported) | GBP 377.7M |
| Of which: Capital Lease Obligations (IFRS16) | GBP 247.5M |
| Of which: Bank Debt (real financial debt) | GBP 130.2M |
| Cash | GBP 30.0M |
| **Net Debt (ex-leases)** | **GBP 100.2M** |
| EBITDA | GBP 304.6M |
| **Net Debt/EBITDA (ex-leases)** | **0.33x** |

**Conclusion:** Dunelm is effectively unlevered. The 3.18x D/E reflects store leases, not financial risk. The company's leverage covenant (net debt ex-leases < 2.5x EBITDA) is comfortably met. The Board actively returns surplus cash to shareholders when net debt ex-leases falls below 0.2x EBITDA (which triggered the 35p special dividend in FY25).

### Competitive Landscape

| Competitor | Market Share | Positioning |
|------------|-------------|-------------|
| IKEA | ~10-12% (est.) | Large format, self-assembly, destination shopping |
| **Dunelm** | **7.9%** | **Specialist homewares, convenient superstores + digital** |
| Next Home | ~5% (est.) | Fashion retailer's home extension |
| B&Q | ~4% (est.) | DIY store with home furnishings |
| John Lewis | ~3% (est.) | Premium, department store format |
| The Range | ~3% (est.) | Value, discount positioning |

Dunelm's 7.9% share is growing (from 7.7% in FY24) and the company targets 10% in the medium term. The combined UK homewares + furniture market is ~GBP 22-28B (estimates vary by scope).

### Moat Analysis

**1. Scale + Specialist Focus (Strong):**
- 200+ stores purpose-built for homewares vs competitors who are generalists
- Buying power with 300,000+ SKUs creates assortment moat
- #1 position allows best store locations and supplier terms

**2. Brand + Customer Loyalty (Strong):**
- Dunelm is the best-known homewares brand in the UK (20.1% brand search share, ahead of IKEA at 19.1%)
- 6M+ loyalty members driving repeat purchase and data-driven personalization
- Net Promoter Score consistently high

**3. Private Label (Strong):**
- ~30% private label penetration drives the 52.4% gross margin (+17pp premium)
- Own-brand ranges (Dorma, etc.) are recognized sub-brands
- Competitors struggle to match this margin profile

**4. Omnichannel Integration (Growing):**
...
## Why It Is Cheap: Narrative vs. Reality
...
4. **UK consumer weakness:** GfK Consumer Confidence -16 in Jan 2026. Cost of living pressures continue. Discretionary spending cautious.

5. **No sustained recovery visible:** Management explicitly stated they have "yet to see signs of a sustained consumer recovery."

### My Counter-Thesis

| Market Believes | I Believe | My Evidence |
|----------------|-----------|-------------|
| Consumer weakness is structural | Consumer weakness is cyclical (2-3 quarters) | UK inflation at 2%, wage growth positive, housing market stabilizing |
...
|--------|-------|---------|
| Industry in secular decline | NO | UK homewares TAM growing 3-4% CAGR |
| Technological disruption imminent | NO | Omnichannel leader, 41% digital |
| Management destroying value | NO | Capital returns, share buybacks, special dividends |
| Balance sheet deteriorating | NO | Net debt/EBITDA 0.33x, improving |
...
**Value Trap Score: 0/10 -- No value trap indicators whatsoever.**
...
|--------|-------|-----------|
| UK Homewares TAM Growth | 3-4% CAGR | Mordor Intelligence: $22B to $27B by 2030 = 4.17% CAGR |
| Market Share Gain | +0.2-0.3pp/year | Trend: 7.7% to 7.9% in FY25. Target 10% in medium term (~5-7 years) |
| Pricing | +1-2% | Private label pricing power, mix shift to higher ticket furniture |
| Store Expansion | 5-10 stores/year | Management guidance. Mainly inner city (London) and relocations |
| **Revenue Growth Base Case** | **5%** | TAM 3.5% + Share 0.5% + Pricing 1% |
...
|-----------|-------|--------|
| Risk-Free Rate | 4.2% | UK 10Y Gilt (Feb 2026) |
| Equity Risk Premium | 5.5% | UK market standard |
| Beta | 0.90 | yfinance |
| Cost of Equity (Ke) | 4.2% + 0.9 x 5.5% = 9.15% | CAPM |
| Cost of Debt (Kd) | 4.0% pre-tax | Interest expense / avg debt, low leverage |
| Tax Rate | 26% | UK corporate |
| Kd after-tax | 2.96% | 4.0% x (1-0.26) |
| Debt weight | 5% (ex-leases) | 100M / (1898M + 100M) |
| Equity weight | 95% | |
| **WACC** | **8.8%** | Rounded to **9.0%** (conservative) |

**Sanity check:** Beta 0.9 is reasonable for a UK consumer retailer. Not as defensive as a utility, but less cyclical than pure discretionary. A WACC of 9% is appropriate.

### Terminal Growth: 2.5%

UK GDP long-term growth ~1.5-2%. Dunelm continues to gain share so terminal growth slightly above GDP is justified. 2.5% is conservative.

---

## Valuation

### Method 1 (Primary, 50% weight): Owner Earnings Yield + Growth

| Metric | Conservative | Adjusted |
|--------|-------------|----------|
| Owner Earnings | GBP 211M (reported FCF) | GBP 228M (OpCF - Maintenance Capex only) |
| Market Cap | GBP 1,898M | GBP 1,898M |
| **OEY** | **11.1%** | **12.0%** |
| Expected Growth | 5% | 5% |
| **OEY + Growth** | **16.1%** | **17.0%** |
| WACC | 9.0% | 9.0% |
| **Spread vs WACC** | **+7.1pp** | **+8.0pp** |

**Interpretation:** At an OEY of 11.1% plus expected growth of 5%, the total expected return of 16.1% vastly exceeds the 9% cost of capital. This spread of +7pp is exceptional for a Tier A company.

**Precedent comparison:** NVO at purchase had OEY + Growth ~12-14%. ADBE ~10-12%. MONY.L ~13-15%. Dunelm's 16% is the most attractive of any Tier A in our portfolio.

**Implied Fair Value (OEY targeting 6% yield = quality premium):**
- FV = FCF / 0.06 = 211M / 0.06 = GBP 3,523M equity = 1,739p per share
- MoS = (1739 - 936.5) / 1739 = 46%

**Implied Fair Value (OEY targeting 7% yield = conservative):**
- FV = 211M / 0.07 = GBP 3,020M = 1,491p per share
- MoS = (1491 - 936.5) / 1491 = 37%

### Method 2 (Secondary, 30% weight): EV/EBIT Normalized

| Parameter | Value | Rationale |
|-----------|-------|-----------|
| EBIT (FY25) | GBP 222M | Reported operating profit |
| EBIT Normalized | GBP 218M | Average of FY25 (222M) and FY26E low (214M) |
| Net Debt (ex-leases) | GBP 100M | Conservative |
| Shares Outstanding | 202.6M | |

| Comparable | EV/EBIT |
|------------|---------|
| UK Retail sector median | 8-10x |
| Next plc (premium UK retailer) | 11-12x |
| B&M European Value Retail | 10x |
| Quality premium (Tier A, market leader, 52% GM) | +2x adjustment |
| **Dunelm Fair Multiple** | **10-12x** |

| Multiple | Fair Value | MoS |
|----------|-----------|-----|
| 10x EBIT | 1,046p | 10% |
| 11x EBIT | 1,156p | 19% |
| 12x EBIT | 1,265p | 26% |

**Central estimate:** 11x EBIT = 1,156p. MoS 19%.

Dunelm currently trades at 9.0x EBIT (ex-leases EV/EBIT). The 5-year average is closer to 13-14x. Even at a discount to historic average, 11x is conservative.

### Method 3 (Tertiary check, 20% weight): DDM

| Parameter | Value |
|-----------|-------|
| Ordinary DPS (FY25) | 43.5p |
| Special Dividend (FY25) | 35p |
| Dividend Growth | 5% (16.5% 5yr CAGR, but slowing; 5% sustainable) |
| Ke | 9.15% |

- DDM (ordinary only): 43.5 x 1.05 / (0.0915 - 0.05) = **1,100p**
- DDM (with 50% probability of specials): ~1,250p
- MoS (ordinary DDM): 15%
- MoS (with specials): 25%

### Reconciliation

| Method | Fair Value | Weight | Weighted |
|--------|-----------|--------|----------|
| OEY + Growth (conservative, 7% target yield) | 1,491p | 50% | 746p |
| EV/EBIT 11x | 1,156p | 30% | 347p |
| DDM (ordinary + partial specials) | 1,175p | 20% | 235p |
...
At 936.5p, the market is pricing in either:
- 0% FCF growth with a 12% WACC (implying UK-recession-level risk premium), or
- Negative FCF growth at any reasonable WACC

This is an absurd level of pessimism for a company that:
- Grew revenue 3.8% in FY25 during consumer weakness
- GAINED market share
...
| | Bear | Base | Bull |
|--|------|------|------|
| **Assumption** | UK recession, consumer collapse, margin compression | Slow recovery, steady share gains, margin stable | Consumer recovery, accelerating share gains, multiple expansion |
| **Revenue Growth** | 0-1% for 2 years then 3% | 5% sustainable | 7% for 3 years, then 5% |
| **Operating Margin** | 11% (compression from competition) | 12.3% (slight near-term pressure) | 13% (operating leverage) |
| **Multiple (EV/EBIT)** | 8x (recession multiple) | 11x (quality retail) | 13x (re-rating to historical) |
| **Fair Value** | 827p | 1,156p | 1,450p |
| **Probability** | 25% | 50% | 25% |
| **Upside/Downside** | -12% | +23% | +55% |

**Expected Value = (827 x 0.25) + (1,156 x 0.50) + (1,450 x 0.25) = 1,147p**

**MoS vs Expected Value: 18%**
**MoS vs Bear Case: -12% (limited downside in Bear)**

The asymmetry is highly favorable: +55% upside in Bull, only -12% downside in Bear. The Bear case requires a UK recession AND margin compression AND multiple contraction -- all three simultaneously.
...
- NVO: MoS 38%, QS 82, -49% from high -- BUY
...
This is directly comparable to AUTO.L (same QS 79, same MoS ~29%) which we bought. The key difference is that DNLM.L is only -25% from high (vs AUTO.L at -47%). However, Dunelm's decline is from a MORE reasonable starting valuation (P/E 15-16x at the high) compared to AUTO.L's decline from a much higher starting valuation.

**Reasoning:** A MoS of ~30% for a Tier A company with:
- 0/10 value trap indicators
- Expanding margins despite weak consumer
...
1. **Gross Margin falls below 48%** (currently 52.4%, would indicate moat erosion or forced discounting)
2. **Market share declines for 2 consecutive years** (currently gaining; decline would invalidate growth thesis)
3. **FCF negative for 2 consecutive years** (would indicate broken business model)
4. **Adderley family sells >10% of their 38.5% stake** (would indicate loss of confidence)
5. **Dividend cut >30%** (would indicate cash flow problems more severe than guided)
6. **Net debt ex-leases exceeds 2.0x EBITDA** (currently 0.33x; would indicate balance sheet stress)
...
- Consumer confidence at -16 (weak but improving from -21 low)
- German fiscal stimulus could lift European sentiment
...
## Veredicto: WATCHLIST -- Entry at 900p or below
