...
- **ROIC-WACC spread:** +37.1pp (exceptional)
- **Gross margin trajectory:** 57.7% -> 55.4% -> 58.3% -> 59.2% [Expanding]
- **FCF:** $995M -> $328M -> $1.6B -> $1.6B (positive 4/4 years)
- **Net Debt/EBITDA:** 0.2x (effectively net cash)
- **Revenue CAGR:** +19.2% | EPS CAGR: +25.0%
...
### Modelo de Negocio
Lululemon es retailer de athleisure premium con modelo **Direct-to-Consumer (DTC)**:
- ~90% ingresos via canales propios (stores + ecommerce)
- Pricing premium (~$100+ yoga pants vs $40-60 competidores)
- Vertical integration parcial (diseno propio, manufactura outsourced)
- Comunidad activa (yoga instructors, brand ambassadors)

### Unit Economics
- **Gross Margin 59.2%** (sector 35.0% -- +24.2pp premium)
- **FCF Margin ~15%**
- **Revenue per store** elevado (modelo high-productivity)
- **DTC economics** = no intermediarios, data directa del cliente
...
- **Contexto macro**: Late cycle, consumer debil en US pero no recesion
